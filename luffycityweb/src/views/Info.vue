          ...
          <div class="course-tab-list">
            ...
            <div class="tab-item" v-if="state.tabIndex===2">
              <div class="tab-item-title">
                ...
                <p class="chapter-length">共{{courses.chapter_list.length}}章 {{courses.info.lessons}}个课时</p>
              </div>
              <div class="chapter-item" v-for="chapter in courses.chapter_list">
...
// 获取url地址栏上的课程ID
courses.course_id = parseInt(route.params.id);
// 简单判断课程ID是否合法
if(courses.course_id > 0){
  // 根据课程ID到服务端获取课程详情数据
