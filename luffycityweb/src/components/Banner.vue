      ...
      <div class="g-banner-content"  @mouseover="state.current_menu=-1">
        <el-carousel :interval="5000" arrow="always" height="482px">
          <el-carousel-item v-for="banner, key in banner.banner_list" :key="key">
            <a v-if="banner.is_http" :href="banner.link"><img :src="banner.image" alt="" style="width: 100%;height: 100%;"></a>
            <router-link v-else :to="banner.link"><img :src="banner.image" alt="" style="width: 100%;height: 100%;"></router-link>
          </el-carousel-item>
        </el-carousel>
     </div>
    </div>
